...
**Phase 20 — UX Scenario Audit**, xem file riêng `docs/ux-scenario-audit.md` (25 tình huống, đọc code chứ không phải người dùng thật ngồi thử — giới hạn ghi rõ trong file đó). Phát hiện 1 lỗ hổng đã sửa ngay (xem dưới) và 1 lỗ hổng còn treo (xem "recipe usage ngược" ở §4).
