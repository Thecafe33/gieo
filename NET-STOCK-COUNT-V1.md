...
| **Loyalty/Reversal/Raw Material/BTP/Alerts/Payroll (L9)** | `StockCountPartiallyApplied` event (SC3) là domain thứ 7 xác nhận phụ thuộc gap L9 |
