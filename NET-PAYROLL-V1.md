...
- 🟡 GIỮ, ĐỔI CÁCH LÀM: **PR2, PR3, PR5, PR6 phần lương giờ** — logic domain đúng, đóng cả 3 gap chain-trace nêu ở tầng thiết kế ([3] payTerms-write-chết, [4] chưa có chốt lương, [6] công thức nghỉ phép để ngỏ); **PR2, PR3, PR4 nay đều đã có đường thực thi thật qua `commands/payroll.js`**
